    ...
    <SectionList
      ...
      renderItem={({ item, index, section }) => (
        <TouchableOpacity
          ...
          key={index}
          onPress={() => {
            this.props.onItemPress(item.icon);
            console.log(item);
          }}
        >
          <View
          ...
          >
            <Icon name={item.icon} color={COLORS.primaryDark} size={25} />
          ...
          {item.switch ? (
            ...
            <Icon name="chevron-right" color={COLORS.primaryDark} size={30} />
          )}
        </TouchableOpacity>
      )}
      ...
      sections={[
        {
          ...
          data: [
            {
              icon: SETTING_ITEMS.creditCard,
              text: "Credit Cards",
              onPress: this.props.onCreditCardPress
            },
